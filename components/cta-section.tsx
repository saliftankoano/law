  ...
  return (
    <section className="relative">
      <div className="absolute inset-0 z-0">
        <Image src="/cta-background.png" alt="Legal Team" fill className="object-cover brightness-50" />
      </div>
      ...
      <div className="relative z-10 px-16 py-24">
        <div className="max-w-2xl">
          ...
          <p className="text-white/90 text-lg mb-8">Let's make it happen together. Contact us today</p>
          <Link
            href="#"
